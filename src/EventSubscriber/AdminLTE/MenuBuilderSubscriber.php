...
class MenuBuilderSubscriber implements EventSubscriberInterface
{
    ...
    protected function getMenuAdmin(Request $request) {
		...
		$menuItems = array(
            $panel = new MenuItemModel('panel', 'Panel', 'admin_home_index', array(/* options */), 'iconclasses fa fa-dashboard'),
            ...
            $producto = new MenuItemModel('praoducto', 'Productos', null, array(/* options */), 'iconclasses fa fa-briefcase'),
        );
    ...
    protected function getMenuPromoter(Request $request) {
        // Build your menu here by constructing a MenuItemModel array
        $menuItems = array(
            $panel = new MenuItemModel('panel', 'Panel', 'promoter_home_index', array(/* options */), 'iconclasses fa fa-dashboard'),
        );
