...
use App\Entity\ShopOrder as EntityCrud;
use App\Entity\ShopOrderDetail;
use App\Form\Type\Admin\ShopOrderType as EntityFormType;

class ShopOrderController extends AbstractController
{
    protected $entityName = 'ShopOrder';
    protected $entityLabel = 'Orden de compra';
    protected $routeList = 'admin_shoporder_list';
    protected $routeAdd = 'admin_shoporder_add';
    protected $routeEdit = 'admin_shoporder_edit';
    protected $routeDelete = 'admin_shoporder_delete';
    protected $parameterId = 'idShopOrder';

    /**
     * @Route("ordencompra/", name="admin_shoporder_list")
     */
    public function list(Request $request){
        ...
        $table_conf = ['columns' => [
                        ...
                        ['header_label' => 'Fecha', 'header_alignment' => 'center', 'field' => 'date', 'data_alignment' => 'center']
                       ], 
                       'cardinal' => true,
    ...
    /**
     * @Route("ordencompra/agregar", 
     *         name="admin_shoporder_add"
     * )
     * @Route("ordencompra/editar/{idShopOrder}", 
     *         defaults={"idShopOrder"=null}, 
     *         requirements={"idShopOrder"="\d+"}, 
     *         name="admin_shoporder_edit"
     * )
     */
    public function edit(Request $request, $idShopOrder = null){
        $entity = $this->entityFromId($idShopOrder);
    ...
    /**
     * @Route("ordencompra/eliminar/{idShopOrder}", 
     *         requirements={"idShopOrder"="\d+"}, 
     *         name="admin_shoporder_delete"
     * )
     */
    public function delete(Request $request, $idShopOrder){
        $entity = $this->entityFromId($idShopOrder);
