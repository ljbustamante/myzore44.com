...
use App\Entity\Depot as EntityCrud;
use App\Form\Type\Admin\DepotType as EntityFormType;

class DepotController extends AbstractController
{
    protected $entityName = 'Depot';
    protected $entityLabel = 'Almacén';
    protected $routeList = 'admin_depot_list';
    protected $routeAdd = 'admin_depot_add';
    protected $routeEdit = 'admin_depot_edit';
    protected $routeDelete = 'admin_depot_delete';
    protected $parameterId = 'idDepot';

    /**
     * @Route("almacen/", name="admin_depot_list")
     */
    public function list(Request $request){
        $entities =  $this->getDoctrine()->getRepository(EntityCrud::class)->findAll();

        $table_conf = ['columns' => [
                        ['header_label' => 'Género', 'header_alignment' => 'left', 'field' => 'depot', 'data_alignment' => 'left'], 
    ...
    /**
     * @Route("almacen/agregar", 
     *         name="admin_depot_add"
     * )
     * @Route("almacen/editar/{idDepot}", 
     *         defaults={"idDepot"=null}, 
     *         requirements={"idDepot"="\d+"}, 
     *         name="admin_depot_edit"
     * )
     */
    public function edit(Request $request, $idDepot = null){
        $entity = $this->entityFromId($idDepot);
    ...
    /**
     * @Route("depot/eliminar/{idDepot}", 
     *         requirements={"idDepot"="\d+"}, 
     *         name="admin_depot_delete"
     * )
     */
    public function delete(Request $request, $idDepot){
        $entity = $this->entityFromId($idDepot);
