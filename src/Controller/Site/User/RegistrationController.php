...
class RegistrationController extends BaseController
{
     ...
     * @return Response
     */
    public function registerAction(Request $request, $promoterSlug = null)
    {
        ...
        return $this->render('Site/User/registration_register.html.twig', array(
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        return $this->render('Site/User/registration_check_email.html.twig', array(
            'user' => $user,
        ));
    }
    ...
    public function confirmedAction(Request $request)
    {
        ...
        return $this->render('Site/User/registration_confirmed.html.twig', array(
            'user' => $user,
